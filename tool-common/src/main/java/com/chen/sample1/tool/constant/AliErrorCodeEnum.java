package com.chen.sample1.tool.constant;

/**
 * @desc 阿里Java开发手册错误码常量表
 * 错误码规范说明：
 ...
 *  9. 错误码分为一级宏观错误码、二级宏观错误码、三级宏观错误码。
...
public enum AliErrorCodeEnum {
    ...
    AliErrorCodeEnum(String code, String description) {
        this.code = code;
